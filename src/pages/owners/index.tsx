      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['position.contains', 'benefits.contains'],
          ...params.filters,
        },
        'owner',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'position', header: 'Position', accessorKey: 'position' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.hired_date ? format(record?.hired_date, 'dd-MM-yyyy') : '',
    },
    { id: 'salary', header: 'salary', accessorKey: 'salary' },
    { id: 'benefits', header: 'Benefits', accessorKey: 'benefits' },
