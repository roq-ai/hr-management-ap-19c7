  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of human resources with HR Management Application, where streamlined processes meet effortless management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of human resources with HR Management Application, where streamlined processes meet effortless management.`}
            </Text>
            <Box
